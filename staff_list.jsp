    ...
    <tr>
      ...
      <c:forEach items="${dbdata}" var="dbdataLine">
        <tr>
          ...
          <td><button type=“button” onclick="location.href='/Attendance/IDGet?id=${dbdataLine.id}&name=${dbdataLine.name}&mail=${dbdataLine.mail}'">編集</button>&nbsp;<input type="button" value="削除" onClick="disp('${dbdataLine.name}', '${dbdataLine.id}')"></td>
        </tr>
      </c:forEach>
  </table>
